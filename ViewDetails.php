...
<nav class="navbar navbar-expand-lg bg-dark"> 
  ...
  <form class="example" action="search.php" method="post">
    ...
    <input type="submit" value="Search" name="submit" style="float: left;  padding: 4px; background: black; color: white; border: 1px solid grey; border-left: none; cursor: pointer;"></input>
  </form>
    ...
    <ul class="nav nav-tabs">
     ...
     -->
      ...
      <?php
       ...
       ?>
          <a class="nav-link dropdown-toggle ml-20"  style="color:white; margin-left:480px;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <?= $_SESSION['auth_user']['name'];?>
          </a>
          <ul class="dropdown-menu" style="margin-left:480px;">
                ...
                while($row=mysqli_fetch_array($query_run))
                {
                    ...
                    <div class="row">
                        <div class="col-md-5" style="height:;">
                            <div class="shadow" >
                                <img src="AdminPanel/upload/<?php echo $row['image']?>" style="width:100%;"alt="">
                            </div>
                        </div>


                        <div class="col-md-7">
                        <h1 class="card-title" style="color:darkblack;"><?php echo $row['product_name'];?></h1>
                        <hr>
                        <?php
                            if($row['qty']==0)
                            {
                        ...
                        <div class="row">
                        <div class="col-md-6">
                                <h3>Rs.<span class="text-success fw-bold"><?= $row['selling_price'];?></span></h3>
                            </div>
                            <div class="col-md-6">
                                <h4>Rs. <s class="text-danger"><?= $row['price'];?></s></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-group mb-3" style="width:100px;">
                                    <button class="input-group-text fw-bold decrement-btn">-</button>
                                        <input type="text" class="form-control qty-input bg-white fw-bold text-center" disabled value="1">
                                    <button class="input-group-text fw-bold increment-btn">+</button>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <button class="btn btn-primary addTo fw-bold" value="<?= $row['product_id'];?>"><ion-icon name="cart-outline"></ion-icon>Add To Cart</button>
                                <a href="wishlist.php?product_id=<?php echo $row['product_id'];?>" class="btn btn-danger fw-bold"><ion-icon name="heart-outline"></ion-icon>Add To Wishlist</a>
 
                            </div>
                            
                        </div>
                        <hr>
                        <h3 class="text-bold">Product Description:</h3>
