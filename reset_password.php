...
if(isset($_REQUEST['email'])){
    ...
    $q="select * from tblreg where email='$email'";
...
<form action="" method="post">
    ...
    <input type="password" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{2,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE tblreg SET password = '$new_password' WHERE email = '$email'";
    // Execute the query
